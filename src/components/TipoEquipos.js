              ...
              {tipoEquipos.map((tipoEquipo, index) => {
                return (
                  <tr key={tipoEquipo._id}>
                    ...
                    <td>
                      {dayjs(tipoEquipo.fechaCreacion).format("YYYY-MM-DD")}
                    </td>
                    <td>
                      {dayjs(tipoEquipo.fechaActualizacion).format(
                        "YYYY-MM-DD"
                      )}
                    </td>
                    <td>
                      ...
                      <button
                        ...
                        onClick={() => deleteTipoEquipo(tipoEquipo._id)}
                      >
                        Eliminar
                      </button>
                    </td>
